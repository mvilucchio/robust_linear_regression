...
files_s = [
    "optimal_loss_double_gauss_{}_{}_{}_{}_{}.npz".format(
        eps, delta_small, delta_large[indice], beta, a
    )
    for a in alphas
]
files_a = [
    "ass_optimal_loss_double_gauss_{}_{}_{}_{}_{}.npz".format(
        eps, delta_small, delta_large[indice], beta, a
    )
    for a in alphas
]
...
fig1, ax1 = plt.subplots(1, 1, figsize=(10, 8), tight_layout=True,)
fig2, ax2 = plt.subplots(nrows=1, ncols=1, figsize=(10, 8), tight_layout=True,)
...
ax1.set_ylabel(r"$\ell_{\mbox{opt}}(z,0)$")
ax1.set_xlabel(r"$z$")
# ax1.set_xscale("log")
# ax1.set_yscale("log")
# ax1.set_ylim([1.5, 20])
...
ax2.set_ylabel(r"$\ell_{\mbox{opt}}(z,0)$")
ax2.set_xlabel(r"$z$")
ax2.set_xscale("log")
ax2.set_yscale("log")
