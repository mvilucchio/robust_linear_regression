...
# np.savetxt(
#     "./data/sweep_delta_fixed_eps_{:.2f}_beta_{:.2f}_alpha_cut_{:.2f}_delta_in_{:.2f}.csv".format(
...
out = np.genfromtxt("./data/sweep_delta_fixed_eps_0.30_beta_0.00_alpha_cut_10.00_delta_in_1.00_bak.csv", skip_header=1, delimiter=',')
