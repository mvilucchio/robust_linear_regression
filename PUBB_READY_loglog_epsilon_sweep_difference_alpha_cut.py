...
# ax.plot(epsilons, l2_err_clipped - bo_err, label=r"$\ell_2$ clipp.", color="tab:blue")
# ax.plot(epsilons, l1_err_clipped - bo_err, label=r"$\ell_1$ clipp.", color="tab:green")
# ax.plot(epsilons, huber_err_clipped - bo_err, label="Huber clipp.", color="tab:orange")
